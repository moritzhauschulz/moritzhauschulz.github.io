  ...
  return (
    <section id="sidebar">
      ...
      <section className="blurb">
        ...
        <p>
          I was an undergraduate at <a href="https://www.lse.ac.uk/economics">LSE</a>. My studies
          were generously supported by the <a href="https://www.sdw.org/index.html">sdw</a> for many
