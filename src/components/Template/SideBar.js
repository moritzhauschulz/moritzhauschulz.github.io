...
const SideBar = () => (
  <section id="sidebar">
    ...
    <section className="blurb">
      <h2>About</h2>
      <p>
        I&apos;m Moritz. I&apos;m interested in mathematics, and how we can use it to drive innovation.
        ...
        machine learning and dynamical systems. This includes generative diffusion processes, how they relate to optimal control and sampling, 
        but also we can use machine learning to model real-world dynamical systems like weather and climate.
